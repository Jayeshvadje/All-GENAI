...
class Review(TypedDict):
    Key_themes :Annotated[list[str],"write down all the things discussed in the review in the list"]
    pros : Annotated[Optional[list[str]],"Write down all the pros inside the list if pros are mentioned other wise do not put it"]
    ...
    sentiment:Annotated [Literal["pos","neg"],"Return sentiment of this review either neutral , negative or positive"]
